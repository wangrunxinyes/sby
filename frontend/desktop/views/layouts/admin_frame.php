...
<!-- BEGIN GLOBAL MANDATORY STYLES -->
  ...
  <?php
		...
		Yii::app ()->assets->registerGlobalCss ( 'global/plugins/font-awesome/css/font-awesome.min.css' );
			...
			<div class="page-header-inner">
				...
				<div class="page-logo">
					...
					<span class="caption-subject bold uppercase font-green-haze"
						style="font-size: 30px;">后台</span> <span
						class="caption-subject bold uppercase font-white-haze"
						style="color: white; font-size: 20px;">管理系统</span>
...
echo Yii::app ()->user->getModel ( 'wrx_photo' );
								?>" /> <span
								class="username username-hide-on-mobile">
                  <?php echo Yii::app()->user->getModel('wrx_username'); ?></span>
							...
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li style="display: none;"><a> <i class="icon-user"></i>
                    <?php
																				$name = "test";
																				if (strlen ( $name ) > 15) {
...
echo '
              <input type="hidden" value="' . yii::app ()->assets->getUrlPath ( 'backend/ajax' ) . '" id="ajax_url">';
								?>
