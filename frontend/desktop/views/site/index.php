...
<link rel="shortcut icon" href="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/favicon.ico"); ?>">
</head>
<body>
<!-- navbar -->
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<h1 class="brand"><a href="index.html" tppabs="#">Helen Shi</a></h1>
				<!-- navigation -->
...
<div id="header-wrapper" class="header-slider">
	...
	<div class="logo">
		<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/logo-image.png"); ?>" alt="" />
	</div>
	<div class="container">
		<div class="row">
			<div class="span12">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="span6">
			<div class="aligncenter">
				<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/icons/creativity.png"); ?>" alt="" />
			</div>
		</div>
	</div>
	<div class="row" style="display:none;">
		<div class="span2 offset1 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/team/img-1.jpg"); ?>" alt="" />
				<h3>John Doe</h3>
				<p>
					Art director
				</p>
		...
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/team/img-2.jpg"); ?>" alt="" />
				<h3>Mike Doe</h3>
				<p>
					Web developer
				</p>
		...
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/team/img-3.jpg"); ?>" alt="" />
				<h3>Neil Doe</h3>
				<p>
					Web designer
				</p>
		...
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/team/img-4.jpg"); ?>" alt="" />
				<h3>Mark Joe</h3>
				<p>
					UI designer
				</p>
		...
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/team/img-5.jpg"); ?>" alt="" />
				<h3>Stephen B</h3>
				<p>
					Digital imaging
				</p>
	...
	<div class="row">
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/icons/laptop.png"); ?>" alt="" />
				<h2>Web design</h2>
				<p>
		...
		<div class="span3 animated flyIn">
			<div class="service-box">
				<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/icons/lab.png"); ?>" alt="" />
		...
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/icons/camera.png"); ?>" alt="" />
				<h2>Photography</h2>
				<p>
					 Lorem Ipsum is simply dummy text of the printing and typesetting industry.
				</p>
		...
		<div class="span3 animated-slow flyIn">
			<div class="service-box">
				<img src="<?php echo Yii::app()->assets->getScirptPath("frame.layout/img/icons/basket.png"); ?>" alt="" />
				<h2>Ecommerce</h2>
				<p>
					 Lorem Ipsum is simply dummy text of the printing and typesetting industry.
				</p>
