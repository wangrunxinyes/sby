...
<head>
	<?php
	Yii::app ()->assets->registerCss ( "extensions/family.assets/css/demo.css" );
...
echo Yii::app ()->assets->getScirptPath ( 'extensions/family.assets/img/wang.jpg' );
								?>"
								alt="profile1">
						</div>
						<h1>
							<span>王润心</span> <span>WANG Runxin</span>
						</h1>
					</div>
...
echo Yii::app ()->assets->getScirptPath ( 'extensions/family.assets/img/me.jpg' );
								?>"
								alt="profile2">
						</div>
						<h1>
							<span>石冰艳</span> <span>SHI Bingyan</span>
						</h1>
					</div>
					<div class="overlay"></div>
				</div>
			...
			<div class="page page-left">
				<div class="page-inner">
					<section>
						...
						<p>简介 | Introduction</p>
						<p>
							<small>喜爱编程，熟悉各种平台语言，理解学习能力强</small> <br> <small> A man who loves
								programming. <br>
							<br>
							<br> <a href="/../wang/index">更多信息 | My Personal website</a>
							</small>
						</p>
