...
<body class="error">
	...
	<div class="container">
		...
		<div class="dialog">
			...
			<h2 class="subhead">
				Sorry&nbsp;|&nbsp;抱歉<br>
				<lable class="description"><?php echo CHtml::encode($message);?></lable>
				<br>
		...
		<div style="width: 100%; margin-top: 5%; text-align: center">
			...
			<iframe scrolling='no' frameborder='0'
				src='http://yibo.iyiyun.com/Home/Distribute/ad404/key/551778'
				width='654' height='470'
				style="display: block; text-align: center; margin: auto;"></iframe>
		</div>

		<div>
			<h5 style="color: white;">
				<a href="http://api.hostinger.com.hk/redir/10806453" target="_blank"
					style="margin-left: 5px;"><img
					src="http://www.hostinger.com.hk/banners/cn/hostinger-80x15-powered-1.gif"
					alt="虚拟主机" width="80" height="15" border="0" /></a>
			</h5>
		</div>
	</div>
