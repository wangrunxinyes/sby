...
echo Yii::app ()->user->getModel ( 'wrx_photo' );
								?>" /> <span
								class="username username-hide-on-mobile">菜单</span> <i
		...
		<div class="page-container">
			...
			<div class="page-sidebar-wrapper">
				...
				<div class="page-sidebar navbar-collapse collapse">
					...
					<ul class="page-sidebar-menu" data-keep-expanded="false"
						...
						<li class="sidebar-search-wrapper">
							...
							<br /> <!-- END RESPONSIVE QUICK SEARCH FORM -->
						</li>

						<li class="start active open"><a href="javascript:;"> <i
								class="icon-home"></i> <span class="title">公众号管理系统</span> <span
                ...
                <?php
																...
																echo $systemMenu->getSpecialSystemMenu ();
