...
while ( $result ) {
	$url = 'http://api.map.baidu.com/place/v2/search?scope=2&page_size=20' . '&page_num=' . $page . '&query=' . urlencode ( $category ) . '&location=' . $bounds . '&radius=100&output=json&ak=X4QYNSSzEH46X7xp10GkCIxF';
