...
$img = R::find ( 'main_web_image_db', ' type = ? ', array (
		"default" 
) );
...
<aside role="complementary" id="aside" aria-hidden="true"
	...
	<a href="#" class="close"><img
		src="<?php echo Yii::app()->assets->getScirptPath('extensions/gallery/img/close-white-thin.svg')?>"
		alt="Close button"><span class="visually-hidden">Return to main
			content</span></a>
