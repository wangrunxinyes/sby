...
<head>
	...
	<![endif]-->
<?=Html::cssFile("@web/include/frame.layout/css/bootstrap-responsive.css");?>
<?=Html::cssFile("@web/include/frame.layout/css/style.css");?>
<?=Html::cssFile("@web/include/frame.layout/color/default.css");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.scrollTo.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.nav.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.localscroll-1.2.7-min.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/bootstrap.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.prettyPhoto.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/isotope.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/jquery.flexslider.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/inview.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/animate.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/validate.js");?>
<?=Html::jsFile("@web/include/frame.layout/js/custom.js");?>
	<link rel="shortcut icon" href="<?php echo AppAsset::getUrlPath("frame.layout/img/favicon.ico"); ?>"></head>
<body>
	<!-- navbar -->
				...
				<div class="container">
					...
					<nav class="pull-right nav-collapse collapse">
						<ul id="menu-main" class="nav">
							...
							<li>
								<a title="avocation" href="#avocation">Avocation</a>
							</li>
							<li>
						...
						<li>
							<a href="page.html">Vocational abilities</a>
						</li>
					</ul>
				</nav>
			</div>
...
<div id="header-wrapper" class="header-slider">
	<header class="clearfix">
		<div class="logo">
			<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/logo-image.png"); ?>" alt="" />
		</div>
		<div class="container">
			<div class="row">
				<div class="span12">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="span6">
			<div class="aligncenter">
				<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/icons/creativity.png"); ?>" alt="" />
			</div>
		</div>
	</div>
	<div class="row" style="display:none;">
		<div class="span2 offset1 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo AppAsset::getUrlPath("frame.layout/img/team/img-1.jpg"); ?>" alt="" />
				<h3>John Doe</h3>
				<p>Art director</p>
			</div>
		</div>
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo AppAsset::getUrlPath("frame.layout/img/team/img-2.jpg"); ?>" alt="" />
				<h3>Mike Doe</h3>
				<p>Web developer</p>
			</div>
		</div>
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo AppAsset::getUrlPath("frame.layout/img/team/img-3.jpg"); ?>" alt="" />
				<h3>Neil Doe</h3>
				<p>Web designer</p>
			</div>
		</div>
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo AppAsset::getUrlPath("frame.layout/img/team/img-4.jpg"); ?>" alt="" />
				<h3>Mark Joe</h3>
				<p>UI designer</p>
			</div>
		</div>
		<div class="span2 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="<?php echo AppAsset::getUrlPath("frame.layout/img/team/img-5.jpg"); ?>" alt="" />
				<h3>Stephen B</h3>
				<p>Digital imaging</p>
			</div>
		</div>
	...
	<div class="row">
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/icons/laptop.png"); ?>" alt="" />
				<h2>Web design</h2>
				<p>
		...
		<div class="span3 animated flyIn">
			<div class="service-box">
				<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/icons/lab.png"); ?>" alt="" />
		...
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/icons/camera.png"); ?>" alt="" />
				<h2>Photography</h2>
				<p>
					Lorem Ipsum is simply dummy text of the printing and typesetting industry.
				</p>
		...
		<div class="span3 animated-slow flyIn">
			<div class="service-box">
				<img src="<?php echo AppAsset::getUrlPath("frame.layout/img/icons/basket.png"); ?>" alt="" />
				<h2>Ecommerce</h2>
				<p>
					Lorem Ipsum is simply dummy text of the printing and typesetting industry.
				</p>
				...
				<form action="contact/contact.php" method="post" class="contactForm">
					<div class="row">
						...
						<div class="span6">
							...
							<input type="submit" value="Send message" class="btn btn-theme pull-left"></div>
					</div>
				</form>
			</div>
		</div>
	...
	<div class="row">
		<div class="span6 offset3">
			<ul class="social-networks">
				...
				<li>
					<a href="#">
						<i class="icon-circled icon-bgdark icon-dribbble icon-2x"></i>
					</a>
				</li>
				<li>
					<a href="#">
						<i class="icon-circled icon-bgdark icon-pinterest icon-2x"></i>
					</a>
				</li>
			</ul>
			<p class="copyright">Copyright &copy; 2015.Helen Shi All rights reserved.</p>
		</div>
	</div>
</div>
<!-- ./container -->
