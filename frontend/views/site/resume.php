				...
				<li id="slide1">
					...
					<div>
						<div class="cbp-content wrx_content_class">
							<p>
								<img src="https://img.alicdn.com/imgextra/i1/112258296/TB2Hkc0dFXXXXXpXpXXXXXXXXXX_!!112258296.jpg" width="133" height="181"></p>
							<p>
								SHI Bingyan
								<br>
								Birthday: 1990/11/13
								<br>
								Email: shibingyan@shibingyan.com
								<br>
								Phone: (852)68163965
								<br><br><br>
								<a style="color:gray;" href="<?php //echo Yii::app()->assets->getScirptPath('documents/cv.pdf');?>">click to download my resume.</a>
								<br></div>
						</div>
					</li>
					<li id="slide2">
